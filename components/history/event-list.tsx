...
import { Camera, Bell, Radio, Play, Download, Calendar } from "lucide-react"
...
const mockEvents = [
  {
    ...
    deviceType: "camera",
    eventType: "motion",
    timestamp: new Date(2025, 3, 21, 12, 45),
    hasRecording: true,
  ...
  },
  {
    ...
    deviceType: "doorbell",
    eventType: "ring",
    timestamp: new Date(2025, 3, 21, 11, 30),
    hasRecording: true,
    thumbnail: "/placeholder.svg?height=120&width=200",
  },
  {
    ...
    deviceType: "sensor",
    eventType: "motion",
    timestamp: new Date(2025, 3, 21, 10, 15),
    hasRecording: false,
    thumbnail: null,
  },
  {
    ...
    deviceType: "camera",
    eventType: "motion",
    timestamp: new Date(2025, 3, 20, 22, 45),
    hasRecording: true,
    thumbnail: "/placeholder.svg?height=120&width=200",
  },
  {
    ...
    deviceType: "doorbell",
    eventType: "ring",
    timestamp: new Date(2025, 3, 20, 18, 20),
    hasRecording: true,
    thumbnail: "/placeholder.svg?height=120&width=200",
  },
  {
    ...
    deviceType: "sensor",
    eventType: "motion",
    timestamp: new Date(2025, 3, 20, 15, 10),
    hasRecording: false,
    thumbnail: null,
  },
]
